 ...
 *
 * Fix this problem by using CopyOnWriteArrayList. It will create a new instance of the list for each adding/removing of element.
...
public class SynchronizedListTutor2 {
    ...
    static String[] animals = { "Cow", "Goose", "Cat", "Dog", "Elephant", "Rabbit", "Snake", "Chicken", "Horse",
            "Human" };
